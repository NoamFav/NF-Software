            ...
            <section className="relative py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    {sections.map((section) => (
                        <div
                            key={section.number}
                            className={`${theme.cardBg} rounded-2xl p-8 md:p-12 border ${theme.border} hover:border-blue-500/50 transition-all duration-300`}
                        >
                            <div className="flex items-start gap-6">
                                ...
                                <div className="flex-1 space-y-4">
                                    ...
                                    {section.note && (
                                        <div
                                            className={`mt-4 p-4 rounded-lg border-l-4 border-blue-500 ${darkMode ? "bg-blue-500/10" : "bg-blue-50"}`}
                                        >
                                            <p
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            >
                                ...
                                we handle your data, please don't hesitate to
                                reach out.
                            </p>
                            <a
                                href="mailto:contact@nf-software.com"
